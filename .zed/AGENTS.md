...
Project-scoped Zed settings that keep configuration templates and generated output from producing irrelevant editor
diagnostics.
...
- Add language associations only when they avoid an editor false positive without hiding diagnostics from maintained
  source files.
